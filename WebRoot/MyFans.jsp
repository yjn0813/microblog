...
<html>
  <head>
	...
	function checkDel(fan_id) {
		if (window.confirm("是否删除 ？")) {
			window.location.href = "deleteFan.do?fan_id=" + fan_id;
		}
	}
</script>
						...
						<c:forEach var="fanList" items="${requestScope.fanList}">
							...
							<tr>
								...
								<td rowspan="3" align="left" width="10%">
									...
									<img class="profile-img" alt="" src="files/${fanList.photo}"
							...
							<tr>
								<td align="left">
									<font size="4"><strong>${fanList.fan_id}
									</strong> </font>

								</td>
								<td width="10%" rowspan="2">
								<a href="javascript:checkDel('${fanList.fan_id}')"><font size="2">删除</font></a>
								</td>
							</tr>
							
							<tr>
								<td align="left">
									<font size="3">简介：<a href="">${fanList.profile}</a>
									</font>
								</td>
								</tr>
