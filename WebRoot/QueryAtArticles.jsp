...
a:hover,a:visited:hover {
  ...
  <body style="background: url('img/bg_repeat_reg.png') repeat-x scroll 0 0 #C8E1F0; margin: 0 0">
	...
	<c:forEach var="at" items="${requestScope.atList}">
				<table width="100%">
					...
					<td width="4%"></td>
						<td rowspan="3" width="20px">
							<img class="profile-img" alt="" src="files/${at.photo}"
				...
				<td width="20%"></td>
					<td width="10%">
						<font size="2"><strong><a href="">@${user.ID}</a></strong>：</font>
					</td>
					<td class="article_content" colspan="2">
					<font size="2">${at.article_content}</font>
					</td>
				</tr>
				<tr>
				<td width="20%"></td>
						<td colspan="2">
						<a href="files/${at.articlePic}" target="_blank"><img width="180px" src="files/${at.articlePic}" /></a>
						</td>
					</tr>
				</table>
