...
$(document).ready(function(){	
	...
	function SetRightHeight(){
		...
		right.height = right.contentDocument.body.offsetHeight+70; 
...
a:hover,a:visited:hover {
   ...
   %>
     ...
     <div class="theme-popover-mask"></div>
				<div class="dashboard">
					<div class="module mini-profile">
						<div class="profile-summary">
							...
							<a href="My.jsp" class="profile-detail">${sessionScope.user.ID}</a> 
							</font></strong>
				...
				<iframe onload="Javascript:SetRightHeight(this)" src="queryFollowsArticles.do" id="right" name="right" width="100%" scrolling="no" frameborder="0" class="iframe-articles"></iframe>
